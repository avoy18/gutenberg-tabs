 ...
 * @since 1.0.0
 */
function anton_blocks_cgb_block_assets() { // phpcs:ignore
	// Register block styles for both frontend + backend.
	wp_register_style(
		'anton_blocks-cgb-style-css', // Handle.
	...
	wp_register_script(
		'anton_blocks-cgb-block-js', // Handle.
	...
	wp_register_style(
		'anton_blocks-cgb-block-editor-css', // Handle.
